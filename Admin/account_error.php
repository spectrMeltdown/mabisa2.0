    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card text-center p-4">
          <div class="card-body">
            <h1 class="card-title mb-3">Account Error</h1>
            <p class="card-text text-muted mb-4">Sorry, a change occurred on your account. Try logging in again or contacting your administrator.</p>
