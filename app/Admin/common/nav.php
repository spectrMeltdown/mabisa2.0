...
<?php endif; ?>
<script src="<?= $doublePathPrepend ?>assets/js/nav.js" defer></script> <!-- for letting js know that this file is nested in folder -->
<script src="<?= $doublePathPrepend ?>assets/js/read_notif.js" defer></script>
<script src="<?= $doublePathPrepend ?>assets/js/all_notif.js" defer></script>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
      <a class="nav-link dropdown-toggle" href="#alerts" id="alertsDropdown" role="button" data-toggle="dropdown"
        ...
        <!-- Counter - Alerts -->
        <?php
        require_once $doublePathPrepend . 'core/db/db.php';
    ...
    <li class="nav-item dropdown no-arrow">
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
        ...
        <img class="img-profile rounded-circle"
          src="<?= !empty($userData['profile_pic']) && is_file($userData['profile_pic']) ? $userData['profile_pic'] : $doublePathPrepend . 'assets/img/default_profile.svg' ?>" />
      </a>
