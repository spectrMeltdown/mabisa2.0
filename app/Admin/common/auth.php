...
if (empty($_COOKIE['id']) && !isset($isLoginPage)) {
  header('location:/mabisa2.0/app/Admin/logged_out.php');
  exit;
}
...
$customUserID = 'self';
$userData;
require_once $pathPrepend . 'app/api/get_user.php'; // this will provide userData array
// unset after using
unset($customUserID);
global $userData;
if (isset($userData['error'])) {
  setcookie('id', '', time() - 3600, '/');
  header('Location:/mabisa2.0/app/Admin/account_error.php');
  exit;
}
