...
if (!(userHasPerms('users_create', 'gen') || userHasPerms('users_update', 'gen'))) {
  header('Location:/mabisa2.0/app/Admin/no_permissions.php');
  exit;
}
?>
...
<head>
  ...
  ?>
  <script src="../../assets/js/util/confirmation.js" defer></script>
  <script src="../../assets/js/util/input-validation.js" defer></script>
  <script src="../../assets/js/util/phone-prepend.js" defer></script>
  <script src="../../assets/js/util/alert.js" defer></script>
  <script src="../../assets/js/users-update.js" defer></script>
  <style>
    /* bigger checkboxes */
    input[type=checkbox] {
